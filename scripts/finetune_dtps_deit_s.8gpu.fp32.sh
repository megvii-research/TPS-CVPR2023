...
learning_cfg="--batch_size 64  --lr 1.25e-4  --epochs 30 --decay 0.05  --warmup-lr 1e-6 --warmup-epochs 5 --backbone_lr_scale 1e-2"
...
python3 train.py --desc ${task_name} \
    --arch dtps_deit_small_patch16_224 --workers 4 \
