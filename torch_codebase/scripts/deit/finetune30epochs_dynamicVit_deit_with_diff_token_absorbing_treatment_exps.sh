...
# 在DynamicVit+DeiT上对比不同, 不同local decay alpha的效果
...
# arch_list=(dynamic_deit_tiny_patch16_224_CosSimTokenAggregateNearestPrunedForEachKeepToken dynamic_deit_tiny_patch16_224_token_merge_avg)
# arch_list=(dynamic_deit_tiny_patch16_224_token_merge_avg dynamic_deit_tiny_patch16_224_token_merge_avg_per_keep_token)
arch_list=(dynamic_deit_tiny_patch16_224_token_merge_softmax_reweight)
# arch_list=(dynamic_deit_tiny_patch16_224_token_merge_avg_per_keep_token dynamic_deit_tiny_patch16_224_token_merge_avg)
...
# arch_list=(dynamic_deit_small_patch16_224 dynamic_deit_small_patch16_224_CosSimNearestPrunedTokenProjAggregate_mean)
...
#                 while : ; do
#                     rlaunch --charged-group=${charged_group} --preemptible=${preemptible}  --positive-tags 2080ti --cpu=64 --gpu=8 --memory=80000 \
#                     -- python3 -m torch.distributed.launch --nproc_per_node=4 --use_env train.py \
#                     --fp16  -c  -dist-eval --pin-mem  --dataset ImageNet \
#                     --grad_checkpoint \
#                     --arch $arch ${deit1_dynamicViT_args} \
