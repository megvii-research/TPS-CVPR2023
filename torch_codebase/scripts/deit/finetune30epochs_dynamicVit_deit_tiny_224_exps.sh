...
arch_list=(dynamic_deit_tiny_patch16_224 dynamic_deit_tiny_patch16_224_CosSimNearestPrunedTokenProjAggregate_mean)
    ...
    do  
        ...
        do 
            ...
            do     
                ...
                while : ; do
                    rlaunch --charged-group=${charged_group} --preemptible=${preemptible}  --positive-tags 2080ti --cpu=32 --gpu=4 --memory=64000 \
