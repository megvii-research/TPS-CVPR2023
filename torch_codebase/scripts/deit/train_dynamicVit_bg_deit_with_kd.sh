...
arch_list_small=(dynamic_deit_small_patch16_224_TokenReorg_mean)
    ...
    do  
        ...
        do 
            ...
            do     
                ...
                while : ; do
                    rlaunch --charged-group=${charged_group} --preemptible=${preemptible}  --positive-tags 2080ti --cpu=48 --gpu=8 --memory=128000 \
...
arch_list_tiny=(dynamic_deit_tiny_patch16_224_TokenReorg_mean)
